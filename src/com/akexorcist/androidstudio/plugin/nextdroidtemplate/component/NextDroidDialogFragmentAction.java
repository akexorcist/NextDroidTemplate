...
public class NextDroidDialogFragmentAction extends BaseNextDroidClassAction {
    ...
    public String[] getValidationClassName() {
        return new String[]{"%sDialogFragment.kt", "%sDialogViewModel.kt"};
    }
    ...
    public void showDialog(GenerateFileRequest request) {
        ...
        dialog.setTitle("Create Dialog Fragment Class");
    ...
    private void createNextDroidFragmentClass(GenerateFileResult result) {
        ...
        addDialogFragmentTemplate(result.getSelectedModule(), result.getClassName(), result.getLayoutName(), javaPath, result.isIncludeLayout());
    ...
    private void addDialogFragmentTemplate(Module module, String className, String layoutName, String targetPath, boolean includeLayout) {
        ...
        addFileTemplate(module, className + "DialogFragment", TEMPLATE_NAME_DIALOG_FRAGMENT, TEMPLATE_EXTENSION_KOTLIN, targetPath, properties);
    }
