...
public class NextDroidFragmentAction extends BaseNextDroidClassAction {
    private static final String TEMPLATE_PATH = "/templates/fragment/";
    private static final String TEMPLATE_NAME_FRAGMENT = "KotlinMvvmCustomFragment";
    ...
    public String[] getValidationClassName() {
        return new String[]{"%sFragment.kt", "%sViewModel.kt"};
    }
    ...
    private void createNextDroidFragmentClass(GenerateFileResult result) {
        ...
        addFragmentTemplate(result.getSelectedModule(), result.getClassName(), result.getLayoutName(), javaPath, result.isIncludeLayout());
    ...
    private void addFragmentTemplate(Module module, String className, String layoutName, String targetPath, boolean includeLayout) {
        ...
        addFileTemplate(module, className + "Fragment", TEMPLATE_NAME_FRAGMENT, TEMPLATE_EXTENSION_KOTLIN, targetPath, properties);
    }
